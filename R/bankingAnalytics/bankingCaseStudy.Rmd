...
data <- read.csv("bankingAnalytics/data/Electronic Funds transfer data_volume.csv", stringsAsFactors = F)
...
# We will consider that the data is not normal and go ahead to understand descroptive statistics
