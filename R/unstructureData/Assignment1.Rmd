...
df.data.science.tweet$hashTagCount <- 
  lapply(df.data.science.tweet$text_transformed, FUN = function(x2) sum(str_count(x2,"#(\\d|\\w)+")))
...
df.data.science.tweet$mlHashTagCount <- 
  lapply(
    ...
    FUN = function(x2) sum(str_count(x2, "#machinelearning")))

df.data.science.tweet$dsHashTagCount <- 
  lapply(
    df.data.science.tweet$text_transformed,
    FUN = function(x2) sum(str_count(x2, "#datascience")))
