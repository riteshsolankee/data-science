...
# lapply(hashtag_tweet_corpus[1:5000], as.character)
...
top10.df <- data.frame(rowSums(as.matrix(hashtag.tdm)))
...
corrplot(cor_hashtags,method="color" )
```
## Part - B
