...
#stop_words
freq_words_df_rm_st_wr <- freq_words_df_sort[! freq_words_df_sort$splitWord %in% stop_words,]
freq_words_df_rm_st_wr
## ploting the dataframe using ggplot and plotly
bar_chart <- ggplot(head(freq_words_df_rm_st_wr, 25), aes(x = reorder(splitWord,-Freq), y = Freq)) + 
