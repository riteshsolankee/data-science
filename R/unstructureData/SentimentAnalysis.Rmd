...
head(tweet.gst)
dim(tweet.gst)
# write.csv(tweet.gst, file = "data/gst_tweet.csv")
...
tweet.gst.100 <- head(tweet.gst, 1000)
tweet.gst.100$sentiment <- RSentiment::calculate_sentiment(tweet.gst.100$text)
...
tweet.gst.100$sentiment1 <- lapply(tweet.gst.100$text, sentence_polarity, positive.words,negative.words)
tweet.gst.100$polarity <- lapply(tweet.gst.100$text, sentence_polarity_count, positive.words,negative.words)
View(tweet.gst.100)

table(unlist(tweet.gst.100$sentiment1))
table(unlist(tweet.gst.100$polarity))
